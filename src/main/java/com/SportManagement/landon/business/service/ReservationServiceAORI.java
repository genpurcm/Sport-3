...
@Service
public class ReservationServiceAORI {
    ...
    @Autowired
    public ReservationServiceAORI(RoomRepository roomRepository, GuestRepository guestRepository, ReservationRepository reservationRepository) {
